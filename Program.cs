...
builder.Services.AddCors(options => {
    ...
    builder => {
        builder.WithOrigins("http://localhost:3000","https://remember-when.azurewebsites.net","http://localhost:5173", "https://rememberwhen.azurewebsites.net", "https://rememberwhen.vercel.app", "http://127.0.0.1:5173")
        .AllowAnyHeader()
        .AllowAnyMethod();
    });
});
